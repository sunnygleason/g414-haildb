...
public class InnoDB implements Library {
    ...
    static {
        Native.register(InnoDB.JNA_LIBRARY_NAME);
    }
    ...
    public static class ib_schema_visitor_t extends Structure {
        ...
        public int version;
        // / < Visitor version
        public InnoDB.ib_schema_visitor_table_t table;
        // / < For travesing table info
        public InnoDB.ib_schema_visitor_table_col_t table_col;
        // / < For travesing table column info
        public InnoDB.ib_schema_visitor_index_t index;
        // / < For travesing index info
        public InnoDB.ib_schema_visitor_index_col_t index_col;
        ...
        public ib_schema_visitor_t(int version,
                InnoDB.ib_schema_visitor_table_t table,
                InnoDB.ib_schema_visitor_table_col_t table_col,
                InnoDB.ib_schema_visitor_index_t index,
                InnoDB.ib_schema_visitor_index_col_t index_col) {
            super();
    ...
    public interface ib_client_cmp_t extends Callback {
        int invoke(InnoDB.ib_col_meta_t col_meta, Pointer p1, int p1_len,
    ...
    public static native void ib_set_client_compare(
            InnoDB.ib_client_cmp_t client_cmp_func);
    ...
    public static native int ib_col_get_meta(Pointer ib_tpl, int i,
            InnoDB.ib_col_meta_t ib_col_meta);
    ...
    public static native int ib_table_schema_visit(Pointer ib_trx, String name,
            InnoDB.ib_schema_visitor_t visitor, Pointer arg);

    public static native int ib_schema_tables_iterate(Pointer ib_trx,
            InnoDB.ib_schema_visitor_table_all_t visitor, Pointer arg);
    ...
    public static final class ib_client_compare {
        ...
        public static synchronized Pointer get() {
            if (ib_client_compare == null)
                ib_client_compare = com.g414.inno.jna.impl.InnoDB.JNA_NATIVE_LIB
